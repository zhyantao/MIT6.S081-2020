...
struct proc {
  ...
  int alarm_interval;         // Alarm interval (0 for disable)
  ...
  int alarm_goingoff;         // Is an alarm currently going off and hasn't yet returned? (prevent re-entrance of alarm_handler)
};
